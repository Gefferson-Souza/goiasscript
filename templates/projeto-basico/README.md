...
1. **Criar nova funcionalidade**: Edite `src/main.gs`
2. **Testar**: Execute `npm run dev`
3. **Verificar**: Execute `npm run check` antes de commitar
4. **Debug**: Use `npm run debug` se algo não estiver funcionando
