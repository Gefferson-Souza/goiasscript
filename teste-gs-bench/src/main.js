...
console.log("=== Projeto teste-gs-bench ===");

var mensagem = "Oi sô! Seu projeto GoiásScript tá funcionando!";
console.log(mensagem);

var nome_projeto = "teste-gs-bench";
console.log("Nome do projeto: " + nome_projeto);

var tecnologias = ["GoiásScript", "JavaScript", "Node.js"];
console.log("Tecnologias usadas:");

for (var i = 0; i < tecnologias.tamanho(); i = i + 1) {
  console.log("• " + tecnologias[i]);
}

var numero_sorte = GoianoMath.arredondar_baixo(GoianoMath.sorteio() * 100);
console.log("Número da sorte: " + numero_sorte);

console.log("🎉 Projeto criado com sucesso!");
console.log("💡 Use: goiasscript vê_se_tá_certo para verificar tipos");
console.log("💡 Use: goiasscript traduz para gerar JavaScript");